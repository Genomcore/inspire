...
`sections-present.sh` reaches past the domain tree into `03_features/`, `01_adr/` and `05_screens/`, which makes the scope argument a contract rather than a convention.

...
**The headless recipe is its own reference.** Invocation, the permission posture
and what it does not cover, scheduling, the preflight, and the operator-facing
morning after and A/B — none of it lives here:

...
shift the contract under their consumers. To modify a stable object:
  1. /inspire-domain demote auth::user::create     # stable → accepted
  2. /inspire-domain update auth::user::create ... # apply the change
  3. /inspire-domain promote auth::user::create stable
```

...
shift the contract under their consumers. To modify a stable object:
  1. /inspire_domain demote auth::user::create     # stable → accepted
  2. /inspire_domain update auth::user::create ... # apply the change
  3. /inspire_domain promote auth::user::create stable
```

...
[`/inspire-module scan`](../../inspire-module/references/module-scan.md), scoped to
...
dialogue, and the chained-authoring handoff to `/inspire-domain define` are that
...
`/inspire-domain`. **Batch mode** (`scan {module}`) expands this over every

...
const report = await agent(
  ...
  `- Phase 4 Vault structure: inspire_kb/ tree matches CLAUDE.md, module hubs (inspire_kb/02_modules/*.md excluding _*.md and README.md) and ADR files (inspire_kb/01_adr/adr-*.md) present with no orphans/phantoms, no stray .py/.xlsx/.DS_Store.\n` +

...
This is the canonical illustration of the cadence `/openbims_object define` expects. Read it to feel the rhythm: one question at a time, show-then-approve, in-line iteration, consolidation by default. The drift this skill exists to prevent is the opposite of this — proposing a field-list structure after a single question.

```
operator: /openbims_object define auth::user::create

...
const READ_ONLY = 'STRICTLY READ-ONLY: flag issues only. NEVER edit a file, NEVER run a fix-skill (/openbims_* create/update/delete), NEVER use Edit/Write. Every finding names the fix-skill to invoke later, but you do not invoke it.'
